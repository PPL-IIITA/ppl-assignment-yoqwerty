 ...
 *
 *
 *<h2> Allocate boyfriends to all girls in the alternate way.Firstly girl chooses boy and then boy chooses a girl and so on</h2>
...
public class couples {
    ...
    int x=0;
      ...
      while(gc<gs-1 && bc<bs-1){
        if(c==0){                     //GIRL CHOOSES BOY
            if(fg.contains(gc)){
                gc++;
