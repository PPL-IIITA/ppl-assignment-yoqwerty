 ...
 *
 *
 *<h2> Allocate boyfriends to all girls in the old allocating method</h2>
 * Stores their names in Excel sheet named coupledata
 */
public class couples_1 {
    ...
    /**
     *<h2> It allocates boyfriends to the girls in the order of randomly generated data in Excel Sheets.It stores the names of couples formed in the sheet named coupledata.xls in the current working directory of the user </h2>
     * @throws IOException
                ...
                if(v2>v1){
                    ...
                    if(att>=req_at){
                        ...
                        if(flag==1){
                            ...
                            System.out.print("girl "+cell1.getContents()+"  chooses : ");
                            cell = row.createCell(1);
                            cell.setCellValue(cell2.getContents());
                            System.out.println(" boy "+cell2.getContents());
                            fl.add(j);
                            k++;
                            flag=0;
                            break;
