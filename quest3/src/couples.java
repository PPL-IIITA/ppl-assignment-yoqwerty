...
public class couples {
    ...
    /**
     * It allocates boyfriends to the girls in the order of randomly generated data in Excel Sheets.It stores the names of couples formed in the sheet named coupledata.xls in the current working directory of the user 
     * @throws IOException
                ...
                if(v2>v1){
                    ...
                    if(att>=req_at){
                        ...
                        if(flag==1){
                            ...
                            System.out.print("girl "+cell1.getContents());
                            cell = row.createCell(1);
